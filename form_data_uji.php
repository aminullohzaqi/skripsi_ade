<form method=POST action='' >
	<table align='center' >
		...
		<tr>
			<td>Latitude Gempa</td>        
			<td>: </td>
			<td>	<input type='text' name='lat'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>Longitude Gempa</td>        
			<td>: </td>
			<td>	<input type='text' name='long'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>Latitude Lokasi Anda</td>        
			<td>: </td>
			<td>	<input type='text' name='latsta'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>Latitude Lokasi Anda</td>        
			<td>: </td>
			<td>	<input type='text' name='longsta'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>Magnitudo</td>        
			<td>: </td>
			<td>	<input type='text' name='magnitudo'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>Kedalaman</td>        
			<td>: </td>
			<td>	<input type='text' name='depth'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>PGA</td>        
			<td>: </td>
			<td>	<input type='text' name='pga'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td>MMI</td>        
			<td>: </td>
			<td>	<input type='text' name='mmi'  style="width:50px;" required="required"></td>						
		</tr>
		<tr>
			<td colspan=2>
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `data_uji` (`lat`, `long`, `latsta`, `longsta`, `magnitudo`, `kategori_magnitudo`, `kedalaman`, `kategori_kedalaman`, `PGA`, `kategori_PGA`, `jarakhipo`, `kategori_jarakhipo`, `MMI`, `efek_gempa`) VALUES 
