...
if (isset($_POST['submit'])) {
	mysql_query("UPDATE data_training SET 
		lat = '$_POST[lat]',
		long = '$_POST[status]',
		latsta = '$_POST[jurusan]',
		longsta = '$_POST[rataUN]',
		kategori_magnitudo = '$_POST[kategori_magnitudo]',
		kategori_kedalaman = '$_POST[kategori_kedalaman]',
		kategori_PGA = '$_POST[kategori_PGA]',
		kategori_jarakhipo = '$_POST[kategori_jarakhipo]',
		efek_gempa = '$_POST[efek_gempa]'
		WHERE id      = '$_GET[id]'");
...
<form method=POST action='' >
	<table align='center' >
		<tr>
			<td colspan=2><b><center>Edit Data User Pengguna</center></b></td>
		</tr>
		<tr>
			<td>NIM</td>        
			<td>: </td>
